                    ...
                    <form className="bg-white shadow-2xl shadow-purple-300 rounded px-8 pt-6 pb-8 mb-4" method="POST" autoComplete="off" onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="username">
                                Student or Teacher's Full Name
                            </label>
                        ...
                        <div className="mb-6">
                            ...
                            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="rollNumber" type="text" value={rollNumber} placeholder="Enter Reg Number" onChange={(e) => setRollNumber(e.target.value)} />
                        </div>
