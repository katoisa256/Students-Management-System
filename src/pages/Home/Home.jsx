      ...
      <div className="flex justify-center min-h-screen items-center flex-wrap">
        <div className="max-w-sm rounded overflow-hidden shadow-2xl shadow-purple-300">
          <div className="px-6 py-4">
            <div className="font-bold text-xl mb-2 text-center">Attendance System</div>
            <p className="text-gray-800 text-base text-center">
              This is a attendance system where you can enter the reg number of students or teacher and keep a record of students and teachers present in the school today
            </p>
          </div>
